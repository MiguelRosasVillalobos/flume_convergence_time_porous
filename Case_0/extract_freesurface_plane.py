...
case_$ifoam = OpenFOAMReader(registrationName='Case_$i.foam', FileName='/home/miguel/Desktop/OpenFOAM_Proyects/flume_convergence_time_porous/Case_$i/Case_$i.foam')
...
# save data
SaveData('/home/miguel/Desktop/OpenFOAM_Proyects/flume_convergence_time_porous/Case_$i/data$p.csv', proxy=contour1, WriteTimeSteps=1,
